...
public class OrdenODBPostgresql extends ODB implements OrdenODB{
	...
	public void insert(Orden orden) {
		String consulta = "insert into fut_ordenes (jugador_id, club_id, tipo, cantidad, precio, estado, es_emision)";
		...
		consulta = consulta + ", '" + orden.getEstado();
		consulta = consulta + "', " + orden.isEsEmision()+");";
	...
	public List<Orden> selectByJugador(Jugador jugador) {
		...
		String comandoSQL = "select orden_id, jugador_id, club_id, tipo, cantidad, precio, estado, es_emision ";
