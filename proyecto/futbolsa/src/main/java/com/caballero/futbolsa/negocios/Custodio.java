...
public class Custodio {
	...
	public static Posesion getPosesionDeJugadorDeClub (Jugador jugador, Club club) {
		CustodioODB odb = new CustodioODBPostgresql();
		return odb.selectPosesionByJugadorClub(jugador, club);
	}

	public static void actualizarDineroJugador (Jugador jugador, Integer cantidad) {
		
	}

	public static void actualizarDineroclub (Club club, Integer cantidad) {
